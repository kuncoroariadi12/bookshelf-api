...
const addBookListHandler = (request, h) => {
    const {
        name,
        year,
        author,
...
const getAllBookListHandler = (request, h) => {
...
const getBookListIdHandler = (request, h) => {
...
const editBookListIdHandler = (request, h) => {
    const { id } = request.params;
    const {
        name,
        year,
...
// delete book by ID
const deleteBookListIdHandler = (request, h) => {
    const { id } = request.params;
